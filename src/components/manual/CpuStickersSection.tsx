const stickerData = [
  ...
  },
  {
    ...
    sticker: "/stickers/2nd-3rd-gen.png",
  },
  {
    era: "2013–2014",
    logo: "Haswell Logo",
  ...
  },
  {
    ...
    sticker: "/stickers/6th-9th-gen.png",
  },
  {
    era: "2019–2020",
    logo: "2019 Logo",
  ...
  },
  {
    ...
    sticker: "/stickers/11-13th-gen.png",
  },
  {
    era: "2023–Present",
    ...
    sticker: "/stickers/14th-15th-gen.png",
  },
];
...
const CpuStickersSection = () => (
  <article className="prose prose-slate dark:prose-invert max-w-none">
    <h1 className="text-3xl font-bold mb-2">
      Intel CPU Stickers by Generation
    </h1>
    ...
    <div className="grid gap-6">
      {stickerData.map((item, index) => (
        <div
          key={index}
          className="flex gap-4 p-4 rounded-lg border bg-card/50 items-center"
        >
    ...
    <p className="text-muted-foreground">
      <strong>K</strong> (unlocked), <strong>F</strong> (no integrated
      graphics), <strong>T</strong> (power-optimized)
    </p>
  </article>
);
